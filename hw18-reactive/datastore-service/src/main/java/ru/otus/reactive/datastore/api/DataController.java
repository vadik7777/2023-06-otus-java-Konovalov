package ru.otus.reactive.datastore.api;
...
import ru.otus.reactive.datastore.domain.MessageDto;
import ru.otus.reactive.datastore.service.DataStore;
...
public class DataController {
    ...
    public Mono<Long> messageFromChat(
            @PathVariable("roomId") String roomId, @RequestBody MessageDto messageDto) {
    ...
    public Flux<MessageDto> getMessagesByRoomId(@PathVariable("roomId") String roomId) {
        return Mono.just(roomId)
                ...
                .flatMapMany(dataStore::loadMessagesByRoomId)
