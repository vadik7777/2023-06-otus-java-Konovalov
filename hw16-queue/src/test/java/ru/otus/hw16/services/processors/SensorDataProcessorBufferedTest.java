...
class SensorDataProcessorBufferedTest {
    private static final Logger log =
            LoggerFactory.getLogger(SensorDataProcessorBufferedTest.class);

    public static final int BUFFER_SIZE = 2000;
    public static final String ANY_ROOM = "AnyRoom";

    @Mock private SensorDataBufferedWriter writer;

    @Captor private ArgumentCaptor<List<SensorData>> captor;
